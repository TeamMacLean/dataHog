      ...
      async.eachSeries(projects, function iterator(project, nextProject) {
        ...
        new Project({
          ...
          async.eachSeries(samples, function iterator(sample, nextSample) {
            ...
            new Sample({
              ...
              async.eachSeries(runs, function iterator(run, nextRun) {
                ...
                new Run({
                  ...
                  addAdditional(additionalPath, rRun, cb);
                ...
                //TODO finished all runs of sample
                nextSample();
              }); //END runs map
              sampleArray.push({
                name: sample,
            ...
            nextProject();
            //TODO finished all samples of project
          }); //END samples map
          projectArray.push({
            name: project,
            samples: sampleArray
        ...
        nextGroup();
        //TODO finished all projects of group
      }); //END projects map
      groupArray.push({
        name: group,
